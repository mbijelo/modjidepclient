...
messageOk(BuildContext context, String _text){
  ...
  mainModel.openDialog("getError1²"+_text);
  */
...
messageError(BuildContext context, String _text){
  ...
  mainModel = Provider.of<MainModel>(context,listen:false);
  dprint("debut40");
  mainModel.openDialog("getError²"+_text);
  dprint("debut41");
  /*
  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
...
messageErrorInternet(BuildContext context, String _text){
  dprint("debut38");
  dprint("messageError $_text");
  dprint("debut39");
  mainModel = Provider.of<MainModel>(context,listen:false);
  dprint("debut40");
  mainModel.openDialog("noInternet1²"+_text);
  dprint("debut41");
  /*
  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      backgroundColor: Colors.red,
...
messageBoxAfterOtpConfirmWell(BuildContext context, String _text){
  dprint("debut38");
  dprint("messageError $_text");
  dprint("debut39");
  mainModel = Provider.of<MainModel>(context,listen:false);
  dprint("debut40");
  mainModel.openDialog("AfterOtpConfirmWell²"+_text);
  dprint("debut41");
  /*
  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      backgroundColor: Colors.red,
