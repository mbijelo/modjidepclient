  ...
  try{
    ...
    if (!temporary){
      ...
      // if (_provider2 != null){
        ...
        var messageToAdmin = "";
        if (_user != null)
         messageToAdmin = userAccountData.userName + " : " + userAccountData.userPhone + " ------>>  : " + _user.providerName + " : " + _user.phone;
...
/*
 ...
 sendMessage("$stringFromUser ${userAccountData.userName}",  /// "From user:",
              stringNewBooking,  /// "New Booking was arrived",
              _user.id, true, appSettings.cloudKey, userAccountData.userName, userAccountData.userPhone);
 */
