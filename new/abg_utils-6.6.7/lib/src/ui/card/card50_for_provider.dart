...
import 'package:ondemandservice/ui/reviews.dart';
...
class Card50forProvider extends StatefulWidget {
  ...
  final String locale;
  final String textt;
  final Function callllBack;

  Card50forProvider({
    this.shadowText = "", required this.category, required this.provider, required this.locale, required this.direction, required this.textt, required this.callllBack,
  });
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                      ...
                      child: Text(widget.textt, style: aTheme.style12W600White,),
                    ),
