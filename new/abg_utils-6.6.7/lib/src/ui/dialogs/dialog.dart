...
class DialogScreen extends StatefulWidget {
  ...
  DialogScreen({required this.body, required this.title, required this.backgroundColor,
    this.width = 80, required this.align, required this.tapBackground, required this.stars, required this.starsCallback});
...
class EasyDialog{
  ...
  this.body, this.titleLine = true, this.bodyLine = true, this.titleWidget, this.colorTitle, this.okButtonText = false, this.cancelText, this.cancelColor,
      ...
      Navigator.of(context).push(
        PageRouteBuilder(
          ...
          pageBuilder: (_, __, ___) {
            DialogScreen _dialog = DialogScreen(body: _bodyBuild,
                title: _titleBuild,
                align: _align,
  ...
  // _simpleDialog2(BuildContext context, Widget w, Color backgroundColor){
  //   Navigator.of(context).push(
  //     PageRouteBuilder(
  //       opaque: false,
